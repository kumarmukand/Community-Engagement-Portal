...
$state=$_POST['state'];
$complainlocation=$_POST['complainlocation'];
...
move_uploaded_file($_FILES["compfile"]["tmp_name"],"userimages/".$compfile);
$query=mysqli_query($con,"insert into tblcomplaints(userId,category,subcategory,complaintType,state,complainlocation,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$state','$complainlocation','$complaintdetials','$compfile')");
...
<html lang="en">
  <head>
    ...
    <title>Complaint Portal | User Register Complaint</title>
...
<label class="col-sm-2 col-sm-2 control-label">Complaint location </label>
<div class="col-sm-6">
<textarea  name="complainlocation" required="required" cols="2" rows="2" class="form-control" maxlength="200"></textarea>
</div>
</div>
