...
<html lang="en">
  <head>
    ...
    <title>Complaint Portal | Complaint Details</title>
...
<?php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Complaint Location </label>
              <div class="col-sm-10">
              <p><?php echo htmlentities($row['complainlocation']);?></p>
              </div>
