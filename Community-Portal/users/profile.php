...
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',CNIC='$CNIC',Gender='$Gender',address='$address',State='$state',country='$country',zipcode='$zipcode' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<label class="col-sm-2 col-sm-2 control-label">Contact</label>
 <div class="col-sm-4">
<input type="tel" name="contactno" required="required" minlength="10" maxlength="10" value="<?php echo htmlentities($row['contactNo']);?>" class="form-control">
</div>

<label class="col-sm-2 col-sm-2 control-label">CNIC</label>
 <div class="col-sm-4">
<input type="tel" name="CNIC" required="required" minlength="15" maxlength="15" value="<?php echo htmlentities($row['CNIC']);?>" class="form-control cnic">
</div>
 </div>
...
<div class="col-sm-4">
<input type="tel" name="zipcode" maxlength="6" required="required" value="<?php echo htmlentities($row['zipcode']);?>" class="form-control">
</div>
