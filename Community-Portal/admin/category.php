...
$sql=mysqli_query($con,"insert into category(categoryName,categoryEmail,categoryDescription) values('$category','$categoryEmail','$description')");
...
<div class="controls">
<input type="text" placeholder="Enter category Name"  name="categoryEmail" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<td><?php echo htmlentities($row['categoryEmail']);?></td>
